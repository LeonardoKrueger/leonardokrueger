...
**Foco atual:** Automação de testes web com Selenium, desenvolvimento frontend com React<br>
**Evoluindo em:** Backend com Node.js/Express, gerenciamento de estado (Context API, Redux, Zustand)<br>
